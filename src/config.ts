...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "Blog powered by MizukiUI",
	siteURL: "https://mizuki-blog-vercel-app.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "bluebirds", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
...
export const profileConfig: ProfileConfig = {
	...
	name: "Bluebirds",
	bio: "Why so serious?    大三口腔医学牲,不懂programming,和平主义者",
	typewriter: {
	...
	links: [
		{
			name: "Bilibli",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/291363060",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/bluebirds261",
		},
		{
			name: "X",
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "天高地迥，觉宇宙之无穷；兴尽悲来，识盈虚之有数。", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "欢迎来到Bluebirds的blog!", // 欢迎词
		touch: [
			"你在干什么？",
			"再摸我就报警了!",
			"HENTAI!",
